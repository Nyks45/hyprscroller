...
Config::ErrorResult CScrollingLayout::layoutMsg(const std::string_view& sv) {
    ...
    if (ARGS[0] == "move") {
        ...
        auto focusedData = focusedWindowData();
        ...
        if (auto WDATA = focusedWindowData())
...
SP<SScrollingWindowData> CScrollingLayout::focusedWindowData() {
